...
* **Version 1.0.10.0 (2026-08-10)** : Updated nuget packages, moved to Net 10.0, fixed the image rotation and the error message boxes, added a test project, publish the setup content self contained.
